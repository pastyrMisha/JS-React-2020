...
inputRub.addEventListener('input', () => {
    ...
    // status — код, например 404 и тп. Пришли в магазин и видим магазин открыт (закрыт, перерыв)
    // statusText — тестовое описание ответа  от сервера.
    // responseText / response — текст ответа сервера. Это то, что backend-разработчик хочет отправить с сервера. Это те товары, которые Вы можете купить в магазине.    
